...
//    MapViewController *mapController = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"mapController"];
//    mapController.request = [NSURLRequest requestWithURL:url];
//    Location *location = self.course.locations;
//    mapController.title = location.building;
//    [self.navigationController pushViewController:mapController animated:YES];
//}
//- (void)pullCourseData {
...
//    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Add to Lists" message:@"Keep track of your courses with Lists. The more you add, the better course recommendations Coursica can give you." preferredStyle:UIAlertControllerStyleActionSheet];
//    
//    for (NSString *listName in [CourseList listNames]) {
//        UIAlertAction *action = [UIAlertAction actionWithTitle:listName style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
//
//@end
>>>>>>> 34773c5... rewrote most of detail, courses, search, breakdown in Swift and mostly migrated model to Realm
