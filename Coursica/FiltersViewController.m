...
////            break;
////    }
//    NSMutableArray *genEdPredicates = [NSMutableArray array];
//    
//    NSArray *genEds = @[@"Aesthetic and Interpretive Understanding",
//                        @"Culture and Belief",
...
//
//        if (button.selected) {
//            [genEdPredicates addObject:[NSPredicate predicateWithFormat:@"SUBQUERY(genEds, $genEd, $genEd.name == %@).@count > 0", genEds[button.tag]]];
//        }
//    }
//    [predicates addObject:[NSCompoundPredicate orPredicateWithSubpredicates:genEdPredicates]];
//
